...
# cv2.waitKey(0)
cv2.imwrite('gabor_image.jpg', features[-4])
...
def add_noise(features, noise_sd=0.1):
    """
    ...
    Returns:
        numpy.ndarray: Noisy feature vector.
    """
    noise = np.random.normal(0, noise_sd, features.shape)
...
store(noisy_coefficients, 'vault.pickle')
