...
image = cv2.imread('right_print1.tif', 0)
...
# cv2.imwrite('og_gabor_image.jpg', features[-4])
# print('gabor features',len(features))
# print("final:", final_values[-4])
...
# store(noisy_coefficients, 'og_vault.pickle')
